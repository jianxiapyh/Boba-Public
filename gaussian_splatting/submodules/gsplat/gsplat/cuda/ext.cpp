...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("intersect_tile_profiled", &gsplat::intersect_tile_profiled);
    ...
    m.def(
        ...
        &gsplat::projection_ewa_3dgs_shared_template_packed_fwd
    );
    m.def(
        "projection_ewa_3dgs_shared_template_sh_rgb_packed_fwd",
        &gsplat::projection_ewa_3dgs_shared_template_sh_rgb_packed_fwd
    );
    m.def(
    ...
    m.def(
        ...
        &gsplat::rasterize_to_pixels_3dgs_fwd_inference
    );
    m.def(
